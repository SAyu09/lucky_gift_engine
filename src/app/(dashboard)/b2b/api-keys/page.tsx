    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="rounded-xl border border-yellow-200 bg-yellow-50 p-6 shadow-sm">
        <div className="flex gap-4">
          ...
          <div>
            <h3 className="text-lg font-medium text-yellow-800">API Key Security</h3>
        ...
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="mt-3 text-sm text-gray-500 space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
              <h4 className="font-medium text-gray-900 mb-2">Signature Verification (Node.js Example)</h4>
