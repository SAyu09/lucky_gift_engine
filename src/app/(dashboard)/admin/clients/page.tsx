      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-1 space-y-6">
          <div className="bg-blue-50 rounded-xl p-5 border border-blue-100">
            <h3 className="text-sm font-bold text-blue-900 uppercase tracking-wider mb-2">How it works</h3>
            <ul className="text-sm text-blue-800 space-y-3 list-disc pl-4">
              ...
              <li>The system generates a cryptographically secure <strong>API Key</strong> and <strong>Webhook Secret</strong>.</li>
          ...
          <div className="bg-white shadow-sm border border-gray-200 rounded-xl p-5">
            <h3 className="text-sm font-semibold text-gray-900 mb-2">Active Clients Map</h3>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={client.id} className="flex justify-between items-center py-2 border-b border-gray-100 last:border-0 pb-0">
                  <span className="text-sm font-medium text-gray-700">{client.name}</span>
                  <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded">Active</span>
                </div>
              ))}
            </div>
          </div>
